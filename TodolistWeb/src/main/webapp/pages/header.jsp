...
<div class="header">
            <div class="nav-header">
                <div class="brand-logo"><a href="Dashboard.jsp"><b><img src="./assets/images/logo.png" alt=""> </b><span class="brand-title"><img src="./assets/images/logo-text.png" alt=""></span></a>
                </div>
                    ...
                    <ul>
                        ...
                        <li class="icons"><a href="javascript:void(0)"><i class="mdi mdi-account f-s-20" aria-hidden="true"></i></a>
                            <div class="drop-down dropdown-profile animated bounceInDown">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li><a href="#"><i class="mdi mdi-user"></i> <span>Profile</span></a>
                                        </li>
