                    ...
                    <div class="form-input-content">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30 m-b-30" action="Register" method="post">
                                	<div class="form-group">
                                        <label>Username</label>
                                        <input type="name" class="form-control" placeholder="Email" name="fullname">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="m-t-30">Dont have an account? <a href="Login.jsp">Register Now</a>
                                    </p>
                                </div>
                            </div>
                        </div>
